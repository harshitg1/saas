...
export default function WhyChooseUs() {
  ...
  return (
    <section className="relative py-12 sm:py-20 bg-gray-50 overflow-hidden">
      {/* Background shapes */}
      ...
      <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10">
        ...
        {/* Candlestick Strip */}
        {/* Differentiators */}
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10 sm:mb-16 md:mt-0">
          {differentiators.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="relative rounded-xl sm:rounded-2xl p-4 bg-white shadow-md hover:scale-105 transition-transform border border-gray-200">
                {index === 0 && (
                ...
                <h3 className="text-base sm:text-lg font-semibold relative z-10">{item.title}</h3>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <Card className="rounded-xl sm:rounded-2xl shadow-md border-0 bg-gradient-to-tr from-white/80 via-blue-50/50 to-indigo-50/80 backdrop-blur-sm">
            <CardHeader className="p-3">
              <CardTitle className="flex items-center gap-2 text-base md:text-xl font-semibold">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {skills.map((skill, index) => (
                  <div key={index} className="flex items-start gap-2">
                    ...
                    <p className="text-sm md:text-base text-gray-700 leading-relaxed">{skill}</p>
                  </div>
                ))}
              </div>
            </CardContent>
